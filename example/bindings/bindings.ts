...
export function add(a0: number, a1: number) {
  let rawResult = symbols.add(a0, a1)
...
export function add2(a0: Input) {
  ...
  let rawResult = symbols.add2(a0_buf, a0_buf.byteLength)
  const result = rawResult
  return result
}
export function add3(a0: number, a1: number) {
  let rawResult = symbols.add3(a0, a1)
  const result = rawResult
  return result
}
export function add4(a0: number, a1: number) {
  let rawResult = symbols.add4(a0, a1)
  const result = rawResult
  return result
}
...
export function sleep(a0: bigint) {
  let rawResult = symbols.sleep(a0)
  const result = rawResult
  return result
}
export function test_buf(a0: Uint8Array) {
  ...
  let rawResult = symbols.test_buf(a0_buf, a0_buf.byteLength)
  const result = rawResult
  return result
}
export function test_buffer_return(a0: Uint8Array) {
  ...
  let rawResult = symbols.test_buffer_return(a0_buf, a0_buf.byteLength)
  const result = readPointer(rawResult)
  return result
}
export function test_buffer_return_async(a0: Uint8Array) {
  ...
  let rawResult = symbols.test_buffer_return_async(a0_buf, a0_buf.byteLength)
  const result = rawResult.then(readPointer)
  return result
}
export function test_hashmap() {
  let rawResult = symbols.test_hashmap()
  const result = readPointer(rawResult)
...
export function test_lifetime(a0: TestLifetimes) {
  ...
  let rawResult = symbols.test_lifetime(a0_buf, a0_buf.byteLength)
  const result = rawResult
  return result
}
export function test_manual_ptr() {
  let rawResult = symbols.test_manual_ptr()
  const result = readPointer(rawResult)
  return result
}
export function test_manual_ptr_async() {
  let rawResult = symbols.test_manual_ptr_async()
  const result = rawResult.then(readPointer)
  return result
}
export function test_mixed(a0: bigint, a1: Input) {
  ...
  let rawResult = symbols.test_mixed(a0, a1_buf, a1_buf.byteLength)
  const result = rawResult
  return result
}
export function test_mixed_order(a0: number, a1: Input, a2: number) {
  ...
  let rawResult = symbols.test_mixed_order(a0, a1_buf, a1_buf.byteLength, a2)
  const result = rawResult
  return result
}
...
export function test_serde(a0: MyStruct) {
  ...
  let rawResult = symbols.test_serde(a0_buf, a0_buf.byteLength)
  const result = rawResult
  return result
}
export function test_str(a0: string) {
  ...
  let rawResult = symbols.test_str(a0_buf, a0_buf.byteLength)
  const result = rawResult
  return result
}
export function test_str_ret() {
  let rawResult = symbols.test_str_ret()
  const result = readPointer(rawResult)
...
export function test_tag_and_content(a0: TagAndContent) {
  ...
  let rawResult = symbols.test_tag_and_content(a0_buf, a0_buf.byteLength)
  const result = rawResult
  return result
}
